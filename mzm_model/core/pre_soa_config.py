...
current_in_pre_soa_x = np.arange(soa_params['current_in_pre_soa_x'], soa_params['current_in_pre_soa_x'] + 1)  # mA
current_in_pre_soa_y = np.arange(soa_params['current_in_pre_soa_y'], soa_params['current_in_pre_soa_y'] + 1)  # mA
...
gs_pre_soa_x = 1.2*evaluate_gs(a0, a1, a2, current_in_pre_soa_x)
p1db_pre_soa_x = evaluate_p1db_pre(b0, b1, b2, current_in_pre_soa_x)
beta_pre_soa_x = evaluate_beta(p1db_pre_soa_x, gs_pre_soa_x)

p_out_pre_soa_x = evaluate_output_power(power_in_pre_soa, gs_pre_soa_x, beta_pre_soa_x)


def post_pre_soa_power_x():
    return p_out_pre_soa_x

post_pre_soa_pw = post_pre_soa_power_x()

gs_pre_soa_y = 1.2*evaluate_gs(a0, a1, a2, current_in_pre_soa_y)
p1db_pre_soa_y = evaluate_p1db_pre(b0, b1, b2, current_in_pre_soa_y)
beta_pre_soa_y = evaluate_beta(p1db_pre_soa_y, gs_pre_soa_y)

p_out_pre_soa_y = evaluate_output_power(power_in_pre_soa, gs_pre_soa_y, beta_pre_soa_y)


def post_pre_soa_power_y():
    return p_out_pre_soa_y

post_pre_soa_pw_x = post_pre_soa_power_x()
post_pre_soa_pw_y = post_pre_soa_power_y()

power_in_post_soa_x = post_pre_soa_pw_x - post_soa_loss
power_in_post_soa_y = post_pre_soa_pw_y - post_soa_loss

gs_post_soa_x = evaluate_gs(a0, a1, a2, current_in_post_soa_x)
p1db_post_soa_x = evaluate_p1db_post(b0, b1, b2, current_in_post_soa_x)
beta_post_soa_x = evaluate_beta(p1db_post_soa_x, gs_post_soa_x)

p_out_post_soa_x = evaluate_output_power(power_in_post_soa_x, gs_post_soa_x, beta_post_soa_x)
...
p1db_post_soa_y = evaluate_p1db_post(b0, b1, b2, current_in_post_soa_y)
beta_post_soa_y = evaluate_beta(p1db_post_soa_y, gs_post_soa_y)

p_out_post_soa_y = evaluate_output_power(power_in_post_soa_y, gs_post_soa_y, beta_post_soa_y)
