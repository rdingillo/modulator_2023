...
from mzm_model.core.modulator_ssfm_params import v_pi, phase_offset, v_off, b, c, vcm_phase, \
    modulation_format
...
def plot_constellation(field_list, type):
    plt.figure(figsize=(7, 7))
    mod_form = str(modulation_format)
    plt.title('Modulation space for '+mod_form+' format ('+type+')')
