...
'PRBS'
poldeg = 10  # polynomial degree for PRBS generator, between 5 and 28
...
sps = 32   # define samples per symbol (N.B. CHOOSE ONLY EVEN NUMBERS TO GET CORRECT RESULTS)
N_taps = sps*num_signals    # length of the filter in samples
beta = 0.15     # roll-off for raised cosine (ideal is 0, actually use 0.09)
